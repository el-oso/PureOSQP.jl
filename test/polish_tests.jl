@testitem "polishing sharpens a loose solution" begin
    ...
    loose = PureOSQP.solve(P, q, A, l, u; eps_abs = 1.0e-3, eps_rel = 1.0e-3, polishing = false)
    sharp = PureOSQP.solve(P, q, A, l, u; eps_abs = 1.0e-3, eps_rel = 1.0e-3, polishing = true)
    @test sharp.polished
...
@testitem "polishing never makes the answer worse" begin
    ...
    for trial in 1:15
        ...
        a = PureOSQP.solve(P, q, A, l, u; eps_abs = 1.0e-4, eps_rel = 1.0e-4, polishing = false)
        b = PureOSQP.solve(P, q, A, l, u; eps_abs = 1.0e-4, eps_rel = 1.0e-4, polishing = true)
